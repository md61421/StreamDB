...
export const siteInfo = {
  title: "StreamDB",
  description:
    "StreamDB - A progressive web app (PWA) to preview any movie or tv show with reviews, ratings, description and posters. Acting as a TMDB client, StreamDB gives you access to login into your TMDB account and add movies or tv shows to your watchlist, set as favorites, rate and get personalized recommendations.",
  url: "https://streamdb-omega.vercel.app",
