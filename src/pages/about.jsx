...
const About = () => {
  return (
    <Fragment>
      <MetaWrapper
        title=' About - StreamDB'
        description='StreamDB - A progressive web app (PWA) to preview any movie or tv show with reviews, ratings, description and posters. Acting as a TMDB client, StreamDB gives you access to login into your TMDB account and add movies or tv shows to your watchlist, set as favorites, rate and get personalized recommendations.'
      ...
      <div css={pageBackgroundStyles}>
        ...
        <LayoutContainer className='relative z-5 flex items-center justify-center py-32 text-center'>
          <div className='max-w-6xl'>
            ...
            <P size='large'>
              <b className='text-accentPrimary'>StreamDB </b>- A progressive web app (PWA) to preview any movie or tv show with reviews, ratings,
